...
class InterestSelectPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        prompt = tk.Label(prompt_frame, text="OPTIONAL: Please select which fields of mathematics interest you.")
        ...
        back_button = tk.Button(button_frame, text="Back", command=lambda: controller.show_frame("CourseSelectPage"))
        back_button.grid(row=25, column=0, padx=5, pady=10, sticky="sw", in_=button_frame)
        next_button = tk.Button(button_frame, text="Next", command=lambda: self.goto_schedule_display())
