class AcademicTime:
    ...
    def progress_time(self, summer_quarters=[]):
        ...
        if self.quarter == "Fall":
        ...
        elif self.quarter == "Spring" and AcademicTime(self.year, "Summer Session 1") not in summer_quarters and AcademicTime(self.year, "Summer Session 2") not in summer_quarters:
            ...
            newtime.quarter = "Fall"
        elif self.quarter == "Summer Session 2":
            newtime.quarter = "Fall"
    ...
    def reverse_time(self, summer_quarters=[]):
        ...
        if self.quarter == "Fall" and AcademicTime(self.year, "Summer Session 2") not in summer_quarters:
            newtime.quarter = "Spring"
        elif self.quarter == "Fall" and AcademicTime(self.year, "Summer Session 2") in summer_quarters:
            newtime.quarter = "Summer Session 2"
        elif self.quarter == "Fall" and AcademicTime(self.year, "Summer Session 2") not in summer_quarters and AcademicTime(self.year, "Summer Session 1") in summer_quarters:
            newtime.quarter = "Summer Session 1"
        elif self.quarter == "Summer Session 2" and AcademicTime(self.year, "Summer Session 1") in summer_quarters:
            newtime.quarter = "Summer Session 1"
        elif self.quarter == "Summer Session 2" and AcademicTime(self.year, "Summer Session 1") not in summer_quarters:
            newtime.quarter = "Fall"
        elif self.quarter == "Summer Session 1":
            newtime.quarter = "Fall"
        elif self.quarter == "Winter":
            newtime.quarter = "Fall"
            newtime.year -= 1
